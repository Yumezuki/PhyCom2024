...
int main() {
    ...
    printf("You entered: ");
    int *ptr = ___;                 // Initialize a pointer to traverse the array
    while (___)      // Loop until the end of the array
        printf("%d ", ___);      // Print the current element and move the pointer
    printf("\n");
    ...
    while (ptr)          // Loop until the end of the array
        printf("%d ", arr);          // Print the current element and move the pointer
    printf("\n");
